...
def tail_points(opponent_score):
    ...
    # BEGIN PROBLEM 2
    tens,ones,i=0,0,0
    while (tens==0 or ones==0) and opponent_score!=0:
        if i==0:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    score, opponent_score, r=0, 0, strategy(0, 0)
    for score in range(0, goal):
        for opponent_score in range(0, goal):
            if r!=strategy(score, opponent_score):
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for num_rolls in range(1, 11):
        t=average(num_rolls, dice)
        print("DEBUG:",t,num_rolls,r)
        if t>r:
            r=t
            n=num_rolls
    return n
